...
public class BodyL : MonoBehaviour {
	...
	public void BodyColorChange()
	{
		...
		this.transform.GetChild (3).gameObject.GetComponent <MeshRenderer> ().material.color = new Color (1, 0, 0);
		this.transform.GetChild (4).gameObject.GetComponent <MeshRenderer> ().material.color = new Color (1, 0, 0);
	}
